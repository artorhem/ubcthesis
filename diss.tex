...
%% For Latex based UML sequence diagrams
\usepackage{tikz}
...
\include{tcs}
\input{device_key.tex}
\input{new-policies.tex} %--paper 
\input{impl.tex} %-- paper (full)
\input{eval.tex} %-- paper (abridged)
\input{limitations.tex}
\input{unmodified_apps.tex}
\input{related.tex}
\input{conclusion.tex} %-- full
